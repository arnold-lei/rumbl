defmodule Rumbl.AuthTest do
    ...
    test "logouts drops session", %{conn: conn} do
        logout_conn =
            conn
    ...
    test "call places for user from session into assigns", %{conn: conn} do
        user = insert_user()
        conn =
            conn
    ...
    test "call with no session sets current_user aassign to nil", %{conn: conn} do
